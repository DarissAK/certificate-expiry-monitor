...
<p>Yes, this service is free. You can add as many domains as you like, however, don't make it excessive. If you do, we
    might contact you to make an arrangement.</p><br>
...
<p>Yes. All certificates in the chain are checked, a maximum of 10. You will receive notification if any of the chain
    certificates expire as well.</p><br>

<h2>Do you provide any guarantees on uptime?</h2>
<p>We provide this service on a best effort base. The project is fully open source, you can set up your own instance if
    you demand 100% uptime.</p><br>
...
<p>Yes. You can check out <a href="https://cipherli.st">Cipherli.st</a> for secure server settings and guides. You can
    also use the <a href="https://ssldecoder.org">SSL Decoder</a> to check your current setup.</p><br>
