...
function remove_domain_check($id, $visitor_ip)
{
    ...
    foreach ($json_a as $key => $value) {
        if ($key == $id) {
            ...
            $deleted_json = json_encode($deleted_json_a,JSON_PRETTY_PRINT);
            ...
            $subject = "Certificate Expiry Monitor subscription removed for " . htmlspecialchars($deleted_json_a[$id]['domain']) . ":" . htmlspecialchars($deleted_json_a[$id]['port']) . ".";
